...
1. Make an [Issue](https://github.com/ligofff/lgf-assets-reserializer/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf-assets-reserializer": "https://github.com/YOUR_USER/lgf-assets-reserializer.git"
        }
    }
```
